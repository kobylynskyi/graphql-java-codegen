 ...
 * Subscribe to events
 */
open class EventsCreatedSubscriptionRequest(private val alias: String?) : GraphQLOperationRequest {

    companion object {
        const val OPERATION_NAME: String = "eventsCreated"
        val OPERATION_TYPE: GraphQLOperation = GraphQLOperation.SUBSCRIPTION
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as EventsCreatedSubscriptionRequest
