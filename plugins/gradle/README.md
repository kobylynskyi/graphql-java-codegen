...
```groovy
plugins {
  id "io.github.kobylynskyi.graphql.codegen" version "5.1.1-SNAPSHOT"
}
```
...
buildscript {
  ...
  dependencies {
    classpath "io.github.kobylynskyi.graphql.codegen:graphql-codegen-gradle-plugin:5.1.1-SNAPSHOT"
  }
}
