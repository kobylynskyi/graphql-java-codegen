...
| `generateSealedInterfaces`                            | Boolean                                                               | false                                                  | This applies to generated interfaces on unions and interfaces in Kotlin. If true, generate sealed interfaces, else generate normal ones. It is only supported in kotlin. |
